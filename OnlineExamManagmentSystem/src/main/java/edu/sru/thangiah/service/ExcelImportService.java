 ...
 * 
 * import org.apache.poi.ss.usermodel.Row; import
 ...
 * 
 * import edu.sru.thangiah.domain.Student; import
 * edu.sru.thangiah.repository.StudentRepository;
 * 
 * @Service public class ExcelImportService {
 * 
 ...
 * 
 * try (Workbook workbook = new XSSFWorkbook(file.getInputStream())) { Sheet
 * sheet = workbook.getSheetAt(0); // Assuming data is in the first sheet
 * 
 * for (Row row : sheet) { // Skip the header row if (row.getRowNum() == 0) {
 * continue; }
 * 
 ...
 * 
 * // Save the student to the database studentRepository.save(student); } } } }
 */